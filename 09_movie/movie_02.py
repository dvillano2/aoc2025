    ...
    for check_0, check_1 in zip(original_data, data_copy[1:]):
        if check_0[0] == check_1[0]:
            ...
            if x_min < check_0[0] < x_max:
                ...
                if check_1[1] in [y_max, y_min] and len(check_1[2]) == 1:
                    return True
                if (y_min < check_0[1] < y_max) or (
                    y_min < check_1[1] < y_max
                ):
                    return True
                if check_0[1] < y_min and check_1[1] > y_max:
                    return True
        ...
        if y_min < check_0[1] < y_max:
            ...
            if check_1[0] in [x_max, x_min] and len(check_1[2]) == 1:
                return True
            if (x_min < check_0[0] < x_max) or (x_min < check_1[0] < x_max):
                return True
            if check_0[0] < x_min and check_1[0] > x_max:
                return True
